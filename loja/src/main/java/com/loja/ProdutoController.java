...
public class ProdutoController {
    ...
    public List<Produto> buscarTodosOsProdutosDaLoja(){
        return this.tabelaProdutos.buscarTdosOsProdutos();
    }
    ...
    @PostMapping
    public Produto cadastrarNovoProdutoNaLoja(@RequestBody Produto dadosNovoPrdouto){
        return this.tabelaProdutos.cadastrarNovoPrdouto(dadosNovoPrdouto);
    }
